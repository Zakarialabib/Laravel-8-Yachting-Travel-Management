<div class="modal fade" id="modal_add_country" tabindex="-1" role="dialog" aria-labelledby="modal_add_country" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('country_create')}}" method="post" data-parsley-validate>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="submit_add_country">{{__('Add')}}</button>
                    <button class="btn btn-primary" id="submit_edit_country">{{__('Save')}}</button>
