                ...
                <div class="row">
                    <div class="col-xs-12 col-md-8 col-md-offset-2">
                        <ul class="banner-breadcrumb color-white clearfix">
                            <li><a class="link-blue-2" href="{{url('/')}}">{{ __('Home') }}</a> /</li>
                            <li><span>{{ __('Deal booking') }}</span></li>
                        </ul>
            ...
            <div class="row padd-90">
                <div class="col-xs-12 col-md-8">
                    ...
                    <div class="simple-group passenger-info bg-grey-2 detail-block" align="center">
                            <h5 class="color-dark-2">{{ __('Total Amount') }}</h5>
                    ...
                    @if(auth()->guest())
                        <div class="simple-group passenger-info bg-grey-2 detail-block">
                            <h4 class="color-dark"><b>{{ __('Existing users, please login') }}</b>  <button type="button" class="btn btn-primary pull-right sign-in">Log In</button></h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" style="text-align: center">
                                            <label></label>
                                            <button class="login btn btn_travel_portal btn-block btn-group sign-in-submit">{{ __('Sign In') }}</button>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <a href="{{url('/register')}}">{{ __('Not a registered customer ? Register here.') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="sign-up-container">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ __('Email') }}</label>
                                            <input name="email" type="email" class="form-control register_email dynax_input_2" placeholder="{{ __('Email') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ __('Password') }}</label>
                                            <input id="password" type="password" class="form-control password dynax_input_2" name="password" placeholder="{{ __('Password') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ __('Confirm Password') }}</label>
                                            <input id="password-confirm" type="password" class="form-control password_confirmation dynax_input_2" name="{{ __('password_confirmation') }}" placeholder="Retype Password">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <button class="btn btn_travel_portal sign-up-submit"> {{ __('Sign Up') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="passenger-detail-body booking-form">
                            <form method="post" action="{{url('deals/booking')}}">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><i class="fa fa-user"></i> {{ __('Adult') }}</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><i class="fa fa-user"></i> {{ __('Child') }}</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><i class="fa fa-user"></i> {{ __('Infant') }}</label>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-entry color-3">
                                            ...
                                            <label class="clearfix" for="text-1">
                                                ...
                                                <p> {{ __('Use logged in customer details') }} </p>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label><i class="fa fa-user"></i> {{ __('Surname') }}</label>
                ...
                <div class="col-xs-12 col-md-4">
                    <div class="right-sidebar" >
                        <div class="detail-block bg-red-3">
                            <h4 class="color-white">{{ __('Details') }}</h4>
                            <div class="details-desc">
                                <p class="color-pink">{{ __('DEAL NAME') }}:  <span class="color-white">{{$deal->name}}</span></p>
                                <p class="color-pink">{{ __('FLIGHT') }}: <span class="color-white"> @if($deal->flight == 1) <i class=" fa fa-check"></i>Available @else <i class=" fa fa-times"></i>Not Available @endif </span></p>
                                <p class="color-pink">{{ __('HOTEL') }}: <span class="color-white"> @if($deal->hotel == 1) <i class=" fa fa-check"></i>Available @else <i class=" fa fa-times"></i>Not Available @endif </span></p>
                                <p class="color-pink">{{ __('ATTRACTION') }}: <span class="color-white"> @if($deal->attraction == 1) <i class=" fa fa-check"></i>Available @else <i class=" fa fa-times"></i>Not Available @endif </span></p>
                                <p class="color-pink">{{ __('ADULT PRICE') }}: <span class="color-white"> {{number_format($deal->adult_price)}} </span></p>
                                <p class="color-pink">{{ __('CHILD PRICE') }}: <span class="color-white"> {{number_format($deal->child_price)}} </span></p>
                                <p class="color-pink">{{ __('INFANT PRICE') }}: <span class="color-white"> {{number_format($deal->infant_price)}}  </span></p>
                                <p class="color-pink">{{ __('CONTACT NUMBER') }}: <span class="color-white"> {{$deal->phone_number}} </span></p>
                            </div>
                        </div>
                        ...
                        <div class="help-contact bg-grey-2">
                            <h4 class="color-dark-2">{{ __('Need Help') }}?</h4>
                            <p class="color-grey">{{ __('Contact us for assistance') }} :</p>
